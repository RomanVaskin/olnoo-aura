...
export const metadata: Metadata = {
  title: 'Купить дом на Истре — цены и предложения | AURE ESTATES',
  description:
...
const faq = [
  ...
  {
    q: 'Чем покупка через AURE ESTATES отличается от объявлений на Авито?',
  ...
  },
  {
    ...
    a: 'На платформе AURE ESTATES представлен клубный посёлок Малое Исаково на Истринском водохранилище. Если вы ищете конкретный посёлок, которого нет в каталоге, напишите об этом в заявке — так мы точнее подберём варианты.',
  },
  {
